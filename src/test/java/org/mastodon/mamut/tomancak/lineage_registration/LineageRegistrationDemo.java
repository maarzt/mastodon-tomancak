...
public class LineageRegistrationDemo
{
	...
	public static final String project3 = "/home/arzt/Datasets/Mette/E3.mastodon";
	...
	public static final String Ml_2022_07_27 = "/home/arzt/Datasets/DeepLineage/Johannes/2022-07-27_NL46xNL22_eachview_2023-07-04_cleaned.mastodon";

	public static final String Ml_2022_09_08 = "/home/arzt/Datasets/DeepLineage/Johannes/2022-09-08_Ml_NL46xNL22_views_2023-07-04_cleaned.mastodon";
	...
	public static void main( String... args )
	{
		...
		showWindows( openAppModel( context, Ml_2020_07_23_MIRRORED ) );
		showWindows( openAppModel( context, Ml_2022_09_08 ) );
		context.service( LineageRegistrationControlService.class ).showDialog();
	}

	private static void showWindows( WindowManager wm )
	{
		TrackSchemeFrame frame = wm.createBranchTrackScheme().getFrame();
		String baseName = FilenameUtils.getBaseName( wm.getProjectManager().getProject().getProjectRoot().getName() );
